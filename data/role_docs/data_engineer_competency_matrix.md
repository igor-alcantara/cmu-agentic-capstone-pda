...
updated: 2026-03-02
---
# Data Engineer: Competency Matrix
...
## Required levels by skill
SQL: required level 4. SQL remains the working language of every engagement.
...
## Skills adjacent to the role
Adjacent skills are welcome and sometimes decisive on a specific client, but they do not count toward the role requirements and a plan should not prioritize them over a gap. Kafka appears where a client needs streaming ingestion. Qlik Sense is the core analytics platform for the consulting practice. Qlik scripting builds the data layer inside the app. Set analysis is how advanced expressions are written in Qlik. Qlik Cloud administration covers tenant configuration, spaces, reload scheduling, identity provider integration, and license management. Data visualization is the consultant's craft. Requirements gathering turns a vague ask into a scoped deliverable. Stakeholder communication is the difference between a delivered dashboard and an adopted one. Statistics at
